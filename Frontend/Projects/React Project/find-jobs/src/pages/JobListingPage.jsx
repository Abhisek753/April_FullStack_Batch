      ...
      <div className='constiner mx-auto px-4'>
        <div className='mb-8'>
          ...
          <div className='bg-white rounded-lg shadow-md p-4 flex items-center gap-3'>
            ...
            <input className='flex-1 focus:outline-none text-gray-700' type='text' placeholder='Search by job title, company, or description...'/>
          </div>
        </div>
        {/* Main content */}
          ...
          <div className='lg:col-span-3 '>
            ...
            {jobs.length===0?(
             <div className='bg-white rounded-lg shadow-md p-12 text-center'>
              <p className='text-gray-500 text-lg'>No jobs found matching you criteria</p>
